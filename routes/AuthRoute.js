...
const AdminAT = require('../middlewares/adminAT')
...
route.get('/auth/admin/detail', AdminAT.authenticateToken, AuthController.get_admin)
...
route.delete('/user', AuthController.delete_user)
